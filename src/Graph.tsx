...
class Graph extends Component {
    ...
    componentDidMount() {
      if (!this.svg){
        ...
        this.nodes = [
          { id: 1, name: "A", reflexive: true },
          { id: 2, name: "B", reflexive: false },
          { id: 3, name: "C", reflexive: false },
          { id: 4, name: "D", reflexive: false },
          { id: 5, name: "E", reflexive: false }
        ];
        ...
        this.svg.append('svg:defs').append('svg:marker')
          ...
          // Add a border around the clickable area
        ...
        // app starts here
        this.svg
          .on('mousedown', (event: any, d: any) => this.mousedown(event, d))
